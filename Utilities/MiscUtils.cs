...
namespace EternityMod
{
    public static partial class EternityUtils
    {
        ...
        public static Color[,] GetColorsFromTexture(this Texture2D texture)
        {
            ...
            texture.GetData(alignedColors); // This fills the color array with all the colors in the texture.
        ...
        public static void StartRain(bool maxSeverity = false, bool worldSync = true)
        {
