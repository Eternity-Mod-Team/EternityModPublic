...
{
    public static partial class EternityUtilsUtils
    {
        /// <summary>
        ...
        {
            // Fall back to zero by default. default(Vector2) could be used in the parameter definition, but this is more clear.
